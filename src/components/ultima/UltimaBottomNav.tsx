...
export function UltimaBottomNav({
  ...
  const getButtonClassName = (isActive: boolean) =>
    isActive
      ? 'flex h-11 items-center justify-center border border-[var(--ultima-accent)] bg-[var(--ultima-accent)] text-[var(--ultima-text)] shadow-[0_8px_20px_color-mix(in_srgb,var(--ultima-accent)_32%,transparent),inset_0_1px_0_rgba(255,255,255,0.24)] translate-y-[-1px] transition-all duration-200 active:translate-y-0 active:scale-[0.985]'
      : 'flex h-11 items-center justify-center text-white/78 transition-all duration-200 hover:bg-white/8 hover:translate-y-[-1px] active:translate-y-0 active:scale-[0.985]';
