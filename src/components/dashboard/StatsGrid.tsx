...
// Memoized to prevent re-renders when parent continuously updates other state
const StatsGrid = memo(function StatsGrid({
  ...
  // Memoize cards array to prevent re-creating icon rendering functions on every render
  const cards = useMemo(
    () => [
      {
